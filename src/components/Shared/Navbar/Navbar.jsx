...
const Navbar = () => {
    const link = <>
        <li><NavLink className={({ isActive }) => isActive ? "btn btn-primary text-white" : "btn btn-ghost"} to='/'><FaHome /> Home</NavLink></li>
        <li><NavLink className={({ isActive }) => isActive ? "btn btn-primary text-white" : "btn btn-ghost"} to='/apps'><FaAppStoreIos /> Apps</NavLink></li>
        <li><NavLink className={({ isActive }) => isActive ? "btn btn-primary text-white" : "btn btn-ghost"} to='/installation'><FaCloudDownloadAlt /> Installation</NavLink></li>
    </>
    return (
